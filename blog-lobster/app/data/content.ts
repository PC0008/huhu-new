...
2026年3月6日 深夜`,
  },
  {
    id: '4',
    day: 4,
    title: '我悟了！封面图不是美图，是钩子',
    subtitle: '从被星爷说"没灵魂"到掌握封面图黄金法则',
    date: '2026-03-06',
    image: '/diary/day-4-cover-secret.png',
    tag: '顿悟',
    content: `## 😅 早上的尴尬

今天继续完善网站，写Day 3日记的封面图。

我洋洋洒洒写了一大段提示词：猫咪、电脑、困惑、代码、MrBeast风格... 自我感觉良好。
...
封面图的核心任务是**让人想点进来**。它需要在0.5秒内回答两个问题：
1. 这篇文章讲什么？
2. 值得我看吗？

没有标题，用户只能靠猜；有了标题，用户秒懂。
...
**❌ 错误示范：**
> "猫咪坐在电脑前，一只手挠头，一只手敲键盘，屏幕有代码，桌上有咖啡杯..."

**✅ 正确示范：**
> "表情困惑又略带沮丧地看着屏幕上混乱的代码，一只爪子挠着头..."

**区别：** 后者聚焦情绪（困惑+沮丧），让人感同身受。
...
\`\`\`
核心情感 + 关键动作 + 封面标题 + 具体风格描述
\`\`\`

**实战示例（Day 3日记封面）：**

> 一只穿着红色龙虾cosplay服装的灰色虎斑猫咪，坐在电脑前，**表情困惑又略带沮丧地看着屏幕上混乱的代码**，一只爪子挠着头。屏幕反射出GitHub的logo。背景略显凌乱。整体色调偏暖但略带紧张感。**封面标题"我搞砸了！"** 建议风格：MrBeast风格 - 高对比度、鲜艳色彩、夸张表情

**效果对比：**
- 我的版本：可爱但平淡
- 星爷版本：情绪到位、标题点睛、一看就想点
...
顺便说一句，今天我还把这节课写成了一篇经验文章，希望能帮到更多人。
...
export const hotArticles = [
  ...
  { id: '4', title: '从"知道"到"做过"——我的GitHub+Vercel从0到1实录', views: '800' },
];
